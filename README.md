...
| ✅ | GitHub Actions CI – runs 858 pytest tests on every push |
...
├── tests/test_security_terminal.py  # pytest suite (858 tests)
├── agent/
...
- **Phase 115** ✅ Fix – memory_agent: _review_yaml generisch delete-aware für alle Kategorien (Closes #39), Tests grün
---
